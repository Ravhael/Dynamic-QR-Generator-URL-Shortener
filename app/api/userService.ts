...
class UserService {
  ...
  public async updateAvatar(file: File): Promise<{ avatar: string }> {
    ...
    try {
      return await apiClient.patch('/users/me/avatar', formData);
    } catch {
  ...
  public async removeAvatar(): Promise<{ avatar: string }> {
    try {
      return await apiClient.patch('/users/me/avatar', { avatar: '' });
    } catch {
  ...
  public async changePassword(currentPassword: string, newPassword: string): Promise<{ message: string }> {
    try {
      return await apiClient.patch('/users/me/password', { currentPassword, newPassword });
    } catch {
  ...
  public async getAccountStats(): Promise<{ 
